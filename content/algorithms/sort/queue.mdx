...
<img src="/images/algorithms/queueBase.png" alt="Queue example" className="my-6" />
...
- enqueue - add value to the queue or push to the queue
- deque - removing value from the queue
