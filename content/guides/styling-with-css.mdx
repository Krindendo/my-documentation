...
description: Many examples of CSS writing
date: 2023-10-20
---



Example: Most common way to write css

You have colors that you define in the root, and then you call them in some components.
