...
The difference between useState and useReducer is in the setState. You simply save data in useState, but useReducer uses the initialization logic you gave to decide how to save new data.
