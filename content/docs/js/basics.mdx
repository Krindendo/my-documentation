...
A **Promise** is an object returned by an a synchronous function, witch represents the current state of the operation. It have two properties: `state` and `result`.
