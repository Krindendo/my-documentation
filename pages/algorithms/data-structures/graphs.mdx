...
<img src="/static/images/algorithms/graph-example.png" alt="Graph dag" className="my-6" />
...
<img src="/static/images/algorithms/graph-dag.png" alt="Graph dag" className="my-6" />
...
<img src="/static/images/algorithms/graph-adj-list.png" alt="Graph adj list" className="my-6" />
...
<img src="/static/images/algorithms/graph-adj-matrix.png" alt="Graph adj matrix" className="my-6" />


### Search

<img src="/static/images/algorithms/graph-search.png" alt="Graph search" className="my-6" />
...
<img src="/static/images/algorithms/graphs-dijkstra.png" alt="Graph search" className="my-6" />
